...
func FloorStamped(schema openbindings.JSONSchema) bool {
...
func AssumptionWarning(decodeStamp string, outputSchema openbindings.JSONSchema) string {
...
func NonDiscriminatingOutput(schema openbindings.JSONSchema) bool {
	if schema == nil {
		return true
	}
