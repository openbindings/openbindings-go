...
var unmarshalTests = []struct {
	...
	// Project's explicit code-unit-preservation delta; input and assertion remain.
	{CaseName: Name(""), in: `"invalid: \uD834x\uDD1E"`, ptr: new(string), out: "invalid: \xed\xa0\xb4x\xed\xb4\x9e"},
	...
	},
	{
		...
		in:       "\"hello\\ud800world\"",
		ptr:      new(string),
		out:      "hello\xed\xa0\x80world",
	},
	{
		CaseName: Name(""),
		in:       "\"hello\\ud800\\ud800world\"",
		ptr:      new(string),
		out:      "hello\xed\xa0\x80\xed\xa0\x80world",
	},
	{
		CaseName: Name(""),
		in:       "\"hello\\ud800\\ud800world\"",
