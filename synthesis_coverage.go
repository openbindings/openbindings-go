...
func NewSynthesisResult(iface *Interface, entries []SynthesisCoverageEntry, exhaustive bool) (*SynthesizeResult, error) {
...
func NewSynthesisResultWithLimitation(iface *Interface, entries []SynthesisCoverageEntry, exhaustive bool, limitation *SynthesisCoverageLimitation) (*SynthesizeResult, error) {
	if iface == nil {
...
func RepresentedCoverageEntries(iface *Interface, sourceIndex int) []SynthesisCoverageEntry {
	if iface == nil {
		return nil
	}
