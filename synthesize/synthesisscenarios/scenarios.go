...
type Scenario struct {
	ID          string                      `json:"id"`
	Description string                      `json:"description"`
	Source      synthesize.SynthesizeSource `json:"source"`
...
// offline.
type SynthesizerFactory func(scenario Scenario) (synthesize.CoverageSynthesizer, error)
...
func Fixed(synth synthesize.CoverageSynthesizer) SynthesizerFactory {
	return func(scenario Scenario) (synthesize.CoverageSynthesizer, error) {
...
func Verify(ctx context.Context, root, family string, factory SynthesizerFactory) error {
	...
	for _, scenario := range file.Scenarios {
		...
		result, err := synth.SynthesizeInterfaceWithCoverage(ctx, &synthesize.SynthesizeInput{
			Sources: []synthesize.SynthesizeSource{scenario.Source},
		})
...
func Match(s Scenario, result *synthesize.SynthesizeResult) error {
...
func coverageEntries(entries []synthesize.SynthesisCoverageEntry) []CoverageEntry {
