...
func fetchStepResult(iface *openbindings.Interface, err error) string {
	if err != nil {
		return err.Error()
	}
	if iface == nil {
...
// synthesis.
func tryFetchOBI(ctx context.Context, client *http.Client, target string) (*openbindings.Interface, error) {
	...
	return openbindings.ParseDocument(body)
}
