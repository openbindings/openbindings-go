...
// schema-mode Connect synthesis. Methods outside the accepted ProtoJSON
// closure are explicit binding-spec exclusions; every admitted method must
// correspond to an emitted binding.
