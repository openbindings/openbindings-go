...
func TestBindingSpecRegistryWarrantsOnlyImplementedFamilies(t *testing.T) {
	...
	want := []string{BindingSpecOpenAPI20, BindingSpecOpenAPI30, BindingSpecOpenAPI31, BindingSpecOpenAPI32}
	var ids []string
	...
	if got := []bool{verdicts[0].Supported, verdicts[1].Supported, verdicts[2].Supported, verdicts[3].Supported}; !reflect.DeepEqual(got, []bool{true, true, true, true}) {
