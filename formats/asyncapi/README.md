...
protocol-independent errors and diagnostics, synthesis, and coverage. The
...
transport facts stay below the operation boundary. Native evidence may be
retained only through diagnostics.
...
sealed 250-repository corpus. The sole raw parser mismatch is invalid external
YAML and remains outside the supported-artifact denominator.
